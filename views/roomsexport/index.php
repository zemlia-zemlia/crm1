...
/* @var $searchModel app\models\RoomsExportSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Rooms Exports';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="rooms-export-index">
    ...
    <p>
        <?= Html::a('Create Rooms Export', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
