...
/**
 * RoomsExportSearch represents the model behind the search form of `app\models\RoomsExport`.
 */
class RoomsExportSearch extends RoomsExport
{
    /**
     * {@inheritdoc}
     */
